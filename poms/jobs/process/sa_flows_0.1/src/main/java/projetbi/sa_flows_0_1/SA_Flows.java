 ...
 * @status
 */
public class SA_Flows implements TalendJob {
	...
	private final String jobName = "SA_Flows";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SA_Flows.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class InsertStruct implements routines.system.IPersistableRow<InsertStruct> {
		final static byte[] commonByteArrayLock_PROJETBI_SA_Flows = new byte[0];
		static byte[] commonByteArray_PROJETBI_SA_Flows = new byte[0];
		...
		public int getFlows_PK() {
			return this.flows_PK;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.flows_PK;
		...
		public boolean equals(Object obj) {
			...
			if (this.flows_PK != other.flows_PK)
				return false;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETBI_SA_Flows.length) {
					if (length < 1024 && commonByteArray_PROJETBI_SA_Flows.length == 0) {
						commonByteArray_PROJETBI_SA_Flows = new byte[1024];
					} else {
						commonByteArray_PROJETBI_SA_Flows = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETBI_SA_Flows, 0, length);
				strReturn = new String(commonByteArray_PROJETBI_SA_Flows, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJETBI_SA_Flows, 0, length);
				strReturn = new String(commonByteArray_PROJETBI_SA_Flows, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETBI_SA_Flows) {
		...
		public String toString() {
			...
			sb.append(",flows_PK=" + String.valueOf(flows_PK));
			sb.append("]");
		...
		public int compareTo(InsertStruct other) {
			...
			returnValue = checkNullsAndCompare(this.flows_PK, other.flows_PK);
			if (returnValue != 0) {
				return returnValue;
			}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("flows");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("flows");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:PmVXI2S1dHOi1rSy/M1Bbo/wyPkxA78tNPgT+eO0rYEf");
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"moment\",\"pid\",\"father_pid\",\"root_pid\",\"system_pid\",\"project\",\"job\",\"job_repository_id\",\"job_version\",\"context\",\"origin\",\"label\",\"count\",\"reference\",\"thresholds\",\"flows_PK\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = ("flows");
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("flows");
				}
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:BxwZEk2xUl9rL85rfIBab3OVnNCrzHf4rMJSsBEW9144");
				...
				String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2
						+ "\" SET \"moment\" = ?,\"pid\" = ?,\"father_pid\" = ?,\"root_pid\" = ?,\"system_pid\" = ?,\"project\" = ?,\"job\" = ?,\"job_repository_id\" = ?,\"job_version\" = ?,\"context\" = ?,\"origin\" = ?,\"label\" = ?,\"count\" = ?,\"reference\" = ?,\"thresholds\" = ? WHERE \"flows_PK\" = ?";
...
// ###############################
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result + ((this.thresholds == null) ? 0 : this.thresholds.hashCode());
					...
					public boolean equals(Object obj) {
						...
						} else if (!this.thresholds.equals(other.thresholds))
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:/3jV442s3yBvQOM9qbT1j/0uE8sWquaSydsZmg==");
				...
				String url_tDBInput_1 = "jdbc:mariadb://" + "localhost" + ":" + "3306" + "/" + "projetbi" + "?"
						+ properties_tDBInput_1;
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							if (rs_tDBInput_1.getString(1) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_1)
									...
									row2.moment = rs_tDBInput_1.getTimestamp(1);
								} else {
									row2.moment = (java.util.Date) year0_tDBInput_1.clone();
								}
							} else {
								row2.moment = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row2.pid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							row2.father_pid = null;
						} else {

							row2.father_pid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row2.root_pid = null;
						} else {

							row2.root_pid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row2.system_pid = null;
						} else {

							row2.system_pid = rs_tDBInput_1.getLong(5);
						...
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							row2.project = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							row2.job = null;
						} else {

							row2.job = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							row2.job_repository_id = null;
						} else {

							row2.job_repository_id = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							row2.job_version = null;
						} else {

							row2.job_version = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							row2.context = null;
						} else {

							row2.context = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
						}
						if (colQtyInRs_tDBInput_1 < 11) {
							row2.origin = null;
						} else {

							row2.origin = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
						}
						if (colQtyInRs_tDBInput_1 < 12) {
							row2.label = null;
						} else {

							row2.label = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
						}
						if (colQtyInRs_tDBInput_1 < 13) {
							row2.count = null;
						} else {

							row2.count = rs_tDBInput_1.getInt(13);
							if (rs_tDBInput_1.wasNull()) {
								row2.count = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 14) {
							...
							row2.reference = rs_tDBInput_1.getInt(14);
							if (rs_tDBInput_1.wasNull()) {
								row2.reference = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 15) {
							row2.thresholds = null;
						} else {

							row2.thresholds = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
						}
						...
						row1 = null;
						finder_tUniqRow_1.moment = row2.moment;
						if (row2.pid == null) {
							finder_tUniqRow_1.pid = null;
						} else {
							finder_tUniqRow_1.pid = row2.pid.toLowerCase();
						}
						if (row2.father_pid == null) {
							finder_tUniqRow_1.father_pid = null;
						} else {
							finder_tUniqRow_1.father_pid = row2.father_pid.toLowerCase();
						}
						if (row2.root_pid == null) {
							finder_tUniqRow_1.root_pid = null;
						} else {
							finder_tUniqRow_1.root_pid = row2.root_pid.toLowerCase();
						}
						finder_tUniqRow_1.system_pid = row2.system_pid;
						if (row2.project == null) {
							finder_tUniqRow_1.project = null;
						} else {
							finder_tUniqRow_1.project = row2.project.toLowerCase();
						}
						if (row2.job == null) {
							finder_tUniqRow_1.job = null;
						} else {
							finder_tUniqRow_1.job = row2.job.toLowerCase();
						}
						if (row2.job_repository_id == null) {
							finder_tUniqRow_1.job_repository_id = null;
						} else {
							finder_tUniqRow_1.job_repository_id = row2.job_repository_id.toLowerCase();
						}
						if (row2.job_version == null) {
							finder_tUniqRow_1.job_version = null;
						} else {
							finder_tUniqRow_1.job_version = row2.job_version.toLowerCase();
						}
						if (row2.context == null) {
							finder_tUniqRow_1.context = null;
						} else {
							finder_tUniqRow_1.context = row2.context.toLowerCase();
						}
						if (row2.origin == null) {
							finder_tUniqRow_1.origin = null;
						} else {
							finder_tUniqRow_1.origin = row2.origin.toLowerCase();
						}
						if (row2.label == null) {
							finder_tUniqRow_1.label = null;
						} else {
							finder_tUniqRow_1.label = row2.label.toLowerCase();
						}
						finder_tUniqRow_1.count = row2.count;
						finder_tUniqRow_1.reference = row2.reference;
						if (row2.thresholds == null) {
							finder_tUniqRow_1.thresholds = null;
						} else {
							finder_tUniqRow_1.thresholds = row2.thresholds.toLowerCase();
						}
						finder_tUniqRow_1.hashCodeDirty = true;
						if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
							KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

							new_tUniqRow_1.moment = row2.moment;
							if (row2.pid == null) {
								new_tUniqRow_1.pid = null;
							} else {
								new_tUniqRow_1.pid = row2.pid.toLowerCase();
							}
							if (row2.father_pid == null) {
								new_tUniqRow_1.father_pid = null;
							} else {
								new_tUniqRow_1.father_pid = row2.father_pid.toLowerCase();
							}
							if (row2.root_pid == null) {
								new_tUniqRow_1.root_pid = null;
							} else {
								new_tUniqRow_1.root_pid = row2.root_pid.toLowerCase();
							}
							new_tUniqRow_1.system_pid = row2.system_pid;
							if (row2.project == null) {
								new_tUniqRow_1.project = null;
							} else {
								new_tUniqRow_1.project = row2.project.toLowerCase();
							}
							if (row2.job == null) {
								new_tUniqRow_1.job = null;
							} else {
								new_tUniqRow_1.job = row2.job.toLowerCase();
							}
							if (row2.job_repository_id == null) {
								new_tUniqRow_1.job_repository_id = null;
							} else {
								new_tUniqRow_1.job_repository_id = row2.job_repository_id.toLowerCase();
							}
							if (row2.job_version == null) {
								new_tUniqRow_1.job_version = null;
							} else {
								new_tUniqRow_1.job_version = row2.job_version.toLowerCase();
							}
							if (row2.context == null) {
								new_tUniqRow_1.context = null;
							} else {
								new_tUniqRow_1.context = row2.context.toLowerCase();
							}
							if (row2.origin == null) {
								new_tUniqRow_1.origin = null;
							} else {
								new_tUniqRow_1.origin = row2.origin.toLowerCase();
							}
							if (row2.label == null) {
								new_tUniqRow_1.label = null;
							} else {
								new_tUniqRow_1.label = row2.label.toLowerCase();
							}
							new_tUniqRow_1.count = row2.count;
							new_tUniqRow_1.reference = row2.reference;
							if (row2.thresholds == null) {
								new_tUniqRow_1.thresholds = null;
							} else {
								new_tUniqRow_1.thresholds = row2.thresholds.toLowerCase();
							}
							...
							row1.moment = row2.moment;
							row1.pid = row2.pid;
							row1.father_pid = row2.father_pid;
							row1.root_pid = row2.root_pid;
							row1.system_pid = row2.system_pid;
							row1.project = row2.project;
							row1.job = row2.job;
							row1.job_repository_id = row2.job_repository_id;
							row1.job_version = row2.job_version;
							row1.context = row2.context;
							row1.origin = row2.origin;
							row1.label = row2.label;
							row1.count = row2.count;
							row1.reference = row2.reference;
							row1.thresholds = row2.thresholds;
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								row3HashKey.moment = row1.moment == null ? null
										: new java.util.Date(row1.moment.getTime());

								row3HashKey.pid = row1.pid;

								row3HashKey.father_pid = row1.father_pid;

								row3HashKey.root_pid = row1.root_pid;

								row3HashKey.system_pid = row1.system_pid;

								row3HashKey.project = row1.project;

								row3HashKey.job = row1.job;

								row3HashKey.job_repository_id = row1.job_repository_id;

								row3HashKey.job_version = row1.job_version;

								row3HashKey.context = row1.context;

								row3HashKey.origin = row1.origin;

								row3HashKey.label = row1.label;

								row3HashKey.count = row1.count;

								row3HashKey.reference = row1.reference;

								row3HashKey.thresholds = row1.thresholds;
							...
							if (tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
								...
								// row3.origin = '" + row3HashKey.origin + "', row3.label = '" +
								// row3HashKey.label + "', row3.count = '" + row3HashKey.count + "',
								// row3.reference = '" + row3HashKey.reference + "', row3.thresholds = '" +
								// row3HashKey.thresholds + "'");
							} // G 071
...
// # Output table : 'Update'
									Update_tmp.moment = row1.moment;
									Update_tmp.pid = row1.pid;
									Update_tmp.father_pid = row1.father_pid;
									Update_tmp.root_pid = row1.root_pid;
									Update_tmp.system_pid = row1.system_pid;
									Update_tmp.project = row1.project;
									Update_tmp.job = row1.job;
									Update_tmp.job_repository_id = row1.job_repository_id;
									Update_tmp.job_version = row1.job_version;
									Update_tmp.context = row1.context;
									Update_tmp.origin = row1.origin != null ? row1.origin
											: new String[] { "tDie_5",
									...
									Update_tmp.label = row1.label;
									Update_tmp.count = row1.count;
									Update_tmp.reference = row1.reference;
									Update_tmp.thresholds = row1.thresholds;
									Update_tmp.flows_PK = row3.flows_PK;
									Update = Update_tmp;
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_1) {
									Insert_tmp.moment = row1.moment;
									Insert_tmp.pid = row1.pid;
									Insert_tmp.father_pid = row1.father_pid;
									Insert_tmp.root_pid = row1.root_pid;
									Insert_tmp.system_pid = row1.system_pid;
									Insert_tmp.project = row1.project;
									Insert_tmp.job = row1.job;
									Insert_tmp.job_repository_id = row1.job_repository_id;
									Insert_tmp.job_version = row1.job_version;
									Insert_tmp.context = row1.context;
									Insert_tmp.origin = row1.origin != null ? row1.origin
											: new String[] { "tDie_5",
													...
													"tJDBCConnection_1" }[(int) (Math.random() * 91)];
									Insert_tmp.label = row1.label;
									Insert_tmp.count = row1.count;
									Insert_tmp.reference = row1.reference;
									Insert_tmp.thresholds = row1.thresholds;
									Insert_tmp.flows_PK = Numeric.sequence("s1", 1, 1);
									Insert = Insert_tmp;
...
// Start of branch "Insert"
							if (Insert != null) {
								...
								if (Insert.label == null) {
									pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(12, Insert.label);
								}

								if (Insert.count == null) {
									pstmt_tDBOutput_1.setNull(13, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(13, Insert.count);
								}

								if (Insert.reference == null) {
									pstmt_tDBOutput_1.setNull(14, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(14, Insert.reference);
								}

								if (Insert.thresholds == null) {
									pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(15, Insert.thresholds);
								}

								pstmt_tDBOutput_1.setInt(16, Insert.flows_PK);
...
// Start of branch "Update"
							if (Update != null) {
								...
								if (Update.label == null) {
									...
									pstmt_tDBOutput_2.setString(12, Update.label);
								}

								if (Update.count == null) {
									pstmt_tDBOutput_2.setNull(13, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2.setInt(13, Update.count);
								}

								if (Update.reference == null) {
									pstmt_tDBOutput_2.setNull(14, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_2.setInt(14, Update.reference);
								}

								if (Update.thresholds == null) {
									pstmt_tDBOutput_2.setNull(15, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_2.setString(15, Update.thresholds);
								}

								pstmt_tDBOutput_2.setInt(16 + count_tDBOutput_2, Update.flows_PK);
...
// ###############################      
	...
	public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.flows_PK = objectIn.readInt();
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				objectOut.writeInt(this.flows_PK);
		...
		public int compareTo(row3Struct other) {
			...
			returnValue = checkNullsAndCompare(this.label, other.label);
			if (returnValue != 0) {
				return returnValue;
			}

			returnValue = checkNullsAndCompare(this.count, other.count);
			if (returnValue != 0) {
				return returnValue;
			}
			...
			returnValue = checkNullsAndCompare(this.thresholds, other.thresholds);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row1,row3) outputs:(Insert,Update)
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:zUmAw7QE8Ax0fmTJaHhFSTI9mQrV3LAE0joN1rQQ/p5P");

				String dbPwd_tDBInput_2 = decryptedPassword_tDBInput_2;

				String url_tDBInput_2 = "jdbc:postgresql://" + "localhost" + ":" + "5432" + "/" + "ProjetBI_SA";
				...
				String dbquery_tDBInput_2 = "SELECT \n  \"public\".\"flows\".\"moment\", \n  \"public\".\"flows\".\"pid\", \n  \"public\".\"flows\".\"father_pid\", \n  "
						+ "\"public\".\"flows\".\"root_pid\", \n  \"public\".\"flows\".\"system_pid\", \n  \"public\".\"flows\".\"project\", \n  \"pub"
						+ "lic\".\"flows\".\"job\", \n  \"public\".\"flows\".\"job_repository_id\", \n  \"public\".\"flows\".\"job_version\", \n  \"pu"
						+ "blic\".\"flows\".\"context\", \n  \"public\".\"flows\".\"origin\", \n  \"public\".\"flows\".\"label\", \n  \"public\".\"flo"
						+ "ws\".\"count\", \n  \"public\".\"flows\".\"reference\", \n  \"public\".\"flows\".\"thresholds\", \n  \"public\".\"flows\"."
						+ "\"flows_PK\"\nFROM \"public\".\"flows\"";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row3.moment = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 1);
						}
						if (colQtyInRs_tDBInput_2 < 2) {
							row3.pid = null;
						} else {

							row3.pid = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
						}
						if (colQtyInRs_tDBInput_2 < 3) {
							row3.father_pid = null;
						} else {

							row3.father_pid = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
						}
						if (colQtyInRs_tDBInput_2 < 4) {
							row3.root_pid = null;
						} else {

							row3.root_pid = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, false);
						}
						if (colQtyInRs_tDBInput_2 < 5) {
							row3.system_pid = null;
						} else {

							row3.system_pid = rs_tDBInput_2.getLong(5);
						...
						if (colQtyInRs_tDBInput_2 < 6) {
							...
							row3.project = routines.system.JDBCUtil.getString(rs_tDBInput_2, 6, false);
						}
						if (colQtyInRs_tDBInput_2 < 7) {
							row3.job = null;
						} else {

							row3.job = routines.system.JDBCUtil.getString(rs_tDBInput_2, 7, false);
						}
						if (colQtyInRs_tDBInput_2 < 8) {
							row3.job_repository_id = null;
						} else {

							row3.job_repository_id = routines.system.JDBCUtil.getString(rs_tDBInput_2, 8, false);
						}
						if (colQtyInRs_tDBInput_2 < 9) {
							row3.job_version = null;
						} else {

							row3.job_version = routines.system.JDBCUtil.getString(rs_tDBInput_2, 9, false);
						}
						if (colQtyInRs_tDBInput_2 < 10) {
							row3.context = null;
						} else {

							row3.context = routines.system.JDBCUtil.getString(rs_tDBInput_2, 10, false);
						}
						if (colQtyInRs_tDBInput_2 < 11) {
							row3.origin = null;
						} else {

							row3.origin = routines.system.JDBCUtil.getString(rs_tDBInput_2, 11, false);
						}
						if (colQtyInRs_tDBInput_2 < 12) {
							row3.label = null;
						} else {

							row3.label = routines.system.JDBCUtil.getString(rs_tDBInput_2, 12, false);
						}
						if (colQtyInRs_tDBInput_2 < 13) {
							row3.count = null;
						} else {

							row3.count = rs_tDBInput_2.getInt(13);
							if (rs_tDBInput_2.wasNull()) {
								row3.count = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 14) {
							...
							row3.reference = rs_tDBInput_2.getInt(14);
							if (rs_tDBInput_2.wasNull()) {
								row3.reference = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 15) {
							row3.thresholds = null;
						} else {

							row3.thresholds = routines.system.JDBCUtil.getString(rs_tDBInput_2, 15, false);
						}
						if (colQtyInRs_tDBInput_2 < 16) {
							row3.flows_PK = 0;
						} else {

							row3.flows_PK = rs_tDBInput_2.getInt(16);
							if (rs_tDBInput_2.wasNull()) {
						...
						row3_HashRow.thresholds = row3.thresholds;

						row3_HashRow.flows_PK = row3.flows_PK;
	...
	public static void main(String[] args) {
		final SA_Flows SA_FlowsClass = new SA_Flows();

		int exitCode = SA_FlowsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SA_Flows.class.getClassLoader()
					.getResourceAsStream("projetbi/sa_flows_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SA_Flows.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SA_Flows");
		}
...
/************************************************************************************************
 * 197452 characters generated by Talend Open Studio for Data Integration on the
 * 5 avril 2023 à 15:13:55 WAT
 ************************************************************************************************/